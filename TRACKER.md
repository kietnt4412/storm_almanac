...
- **PGR is read first-hand** ([the note](docs/game-facts/punishing-gray-raven-research-disclosure.md)) and
  [its bundle](data/bundles/punishing-gray-raven-steering-by-light.json) is **published at sequence 8** (2026-09-24) — 121
  facts over nine provenance entries, the level ladder, thirteen Promote gates, one weekly ladder, a
  **05:00 UTC** reset, and since 2026-09-22 a **pull price**. Every sequence has published and
  read back as *no changes*, sequence 8 included — in both databases. **Sequence 7 closed N37 and N28's modelling half** and is the
